...
<body>
    ...
    <div class="container">
        ...
        <h3><a href="${pageContext.request.contextPath}/api/v1/employees/add" class="btn btn-primary">New Employee</a></h3>
            ...
            <tbody>
                <c:forEach items="${employees}" var="employee" varStatus="loop">
                    <tr>
                        ...
                        <td>
                            <a href="${pageContext.request.contextPath}/api/v1/employees/${employee.id}" class="btn btn-sm btn-primary">Edit</a>
